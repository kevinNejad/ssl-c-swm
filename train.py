...
parser.add_argument('--ssl-loss', type=str, default='contrastive',
                    help='self supervised loss function.')
...
exp_counter = 0
save_folder = '{}/{}/{}/'.format(args.save_folder,args.seed,exp_name)
...
model = modules.ContrastiveSWM(
    ...
    ssl_loss= args.ssl_loss).to(device)
